...
contractors_list = [
    ("Иванов Иван", "ООО Рога и Копыта", 79123456789, "Москва, ул. Ленина, д.10", "123456789", 1, "Поставщик"),
    ...
    (
    "Николаев Николай", "ОАО Николаев и партнеры", 79567890123, "Санкт-Петербург, ул. Рубинштейна, д.8", "567890123", 2,
    "Поставщик"),
    ("Григорьев Григорий", "ИП Григорьев", 79678901234, "Екатеринбург, ул. Малышева, д.50", "678901234", 3,
     "Покупатель")]
...
oder_list = [('2023-12-22 12:00:00', '2023-12-24 15:00:00', 'in transit', 63000.00, 4,
              "Санкт-Петербург, наб. реки Мойки, д.22", 1)]
...
with con:
    ...
    depot_id, flag_expired, expiration_date, amount, on_hold) VALUES (?,?,?,?,?,?,?,?,?,?,?)'''
    ...
    sql_insert = '''INSERT OR IGNORE INTO Contractors (name, org_name, phone, location, unp, depots_id, type)
     VALUES (?,?,?,?,?,?,?)'''
    ...
    total_price, driver_id, location, list_id)  VALUES (?,?,?,?,?,?,?)'''
    for i in oder_list:
        con.execute(sql_insert, i)
    else:
